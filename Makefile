#############################################################################
# Makefile for building: stlmap_Vs_eaVecMap
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  stlmap_Vs_eaVecMap.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile stlmap_Vs_eaVecMap.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = stlmap_Vs_eaVecMap1.0.0
DISTDIR = /home/yioannidis/STLMAP-vs-EAVECMAP/.tmp/stlmap_Vs_eaVecMap1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/qt/5.5/gcc_64
LIBS          = $(SUBLIBS) -L/usr/local/lib -lEASTL -lstdc++ 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		stlmap_Vs_eaVecMap.pro  main.cpp
QMAKE_TARGET  = stlmap_Vs_eaVecMap
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = stlmap_Vs_eaVecMap
...
Makefile: stlmap_Vs_eaVecMap.pro /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/qt/5.5/gcc_64/mkspecs/common/unix.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/linux.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/qt/5.5/gcc_64/mkspecs/features/yacc.prf \
		/opt/qt/5.5/gcc_64/mkspecs/features/lex.prf \
		stlmap_Vs_eaVecMap.pro
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile stlmap_Vs_eaVecMap.pro
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/stlmap_Vs_eaVecMap/bin || mkdir -p $(INSTALL_ROOT)/opt/stlmap_Vs_eaVecMap/bin
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/stlmap_Vs_eaVecMap/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/stlmap_Vs_eaVecMap/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/stlmap_Vs_eaVecMap/bin/ 
